...
<body>
	<div class="container-fluid" align="center">
		    <h1 class="mt-4">아이디찾기</h1>
		    <div class="cont">
				<form action="findIdOk" method="POST">
			    <table class="tab">
			    	<tr>
			    		<td colspan="3">이름과 이메일을 입력하세요.</td>
			    	</tr>
			    	<tr>
			    		<th>NAME</th>
			    	...
			    	<tr>
			    		<td colspan="3"><input type="submit" value="아이디찾기" style="width:100px; height:30px;">&nbsp;&nbsp;&nbsp;&nbsp;
    		...
    		<div><h4><a class="na" href="login">로그인하러가기</a></h4></div>
	   		...
	   		<div><h4>※회원이 아니신가요? =><a class="na" href="#"> 회원가입 </a></h4></div>
		</div>
</body>
</html>